...
<main id="main-content" class="w-full ">
    <div class="container my-6">
        <div class="lg:flex-row flex-col flex w-full justify-between ">
            ...
            {{-- sidebar:start --}}
            <div id="sidebar" class="mb-5 lg:w-4/12 w-full lg:mx-5 lg:mt-0 mt-8 mx-0 lg:px-0 px-3">
        ...
        <div class="mt-8 lg:mt-0">
            <div class="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:-mx-2">
                <input id="email" type="text"
                    class="px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md sm:mx-2 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
